...
import styles from './map-graph.module.scss';
...
const MapGraph = ({ mapData = {} }) => {
  ...
  useEffect(() => {
    if (!map) {
      loadExternalScript('jquery', () => {
        loadExternalScript('jvectormap', () => {
          loadExternalScript('worldmap', () => {
            setMap(
              ...
              $('#map-graph').vectorMap({
                ...
                onRegionTipShow: (e, tip, code) => {
                  tip.html(
                    `<ul><li>${getString(`countries.${code}`)}</li><li>${
                      mapData[code] || '0'
                    }</li></ul>`
                  );
                },
  ...
  return <div id='map-graph' className={styles.mapGraph} />;
};
