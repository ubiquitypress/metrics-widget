...
The current production version of the widget is `0.0.22`, and it is 193KB in size. The JavaScript file is hosted on a CDN, and can be found here:<br />
https://storage.googleapis.com/operas/metrics-widget-0.0.22/widget.js
