...
The current production version of the widget is `0.1.10`, and it is 184KB in size. The JavaScript file is hosted on a CDN, and can be found here:<br />
https://storage.googleapis.com/operas/metrics-widget-0.1.10/widget.js
...
https://storage.googleapis.com/operas/metrics-widget-0.1.10/widget.css
